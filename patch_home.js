...
if (!code.includes('Qtd. de Questões')) {
  const sliderSection = `
...
code = code.replace(/marginTop: spacing\.xl, marginBottom: spacing\.sm/g, 'marginTop: spacing.sm, marginBottom: spacing.sm'); // Just to adjust spacing between Qtd de Questões and Tema, we will manually fix in next step if it's wrong
